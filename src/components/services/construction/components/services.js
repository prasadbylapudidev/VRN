      ...
      <div className='container'>
        <div className='section-title'>
          ...
          <p style={{color:'white',fontSize:'20px'}}>
            Discover our all-in-one construction solution—where efficiency meets quality for seamless project excellence.
          </p>
        </div>
        <br/>
        <div className='row'>
...
const getIcon = (iconName) => {
  switch (iconName) {
    ...
    case 'fa fa-wrench':
      return faWrench;
    case 'fa fa-paint-roller':
      return faPaintRoller;
    case 'fa fa-truck-pickup':
